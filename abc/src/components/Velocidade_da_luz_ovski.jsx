...
function Velocidade_da_luz_ovski() {
...
function calcular_velocidade(){
  ...
  return (
    <div className="bloco_de_atividade">
      ...
      <h2>Exercício Lista 2 | Atividade 1 & 2</h2>
...
export default Velocidade_da_luz_ovski
