...
function Desconto() {
    ...
    const valor_para_desconto = 20.00;
    const cem = 100;
    const quarenta_e_cinco = 45;
    const trinta = 30;
    let quarenta_e_cinco_porcento_de_desconto;
    let trinta_porcento_de_desconto;

    function definir_preco(){

        trinta_porcento_de_desconto = parseFloat(valor_inserido_no_input) * quarenta_e_cinco / cem;
        quarenta_e_cinco_porcento_de_desconto = parseFloat(valor_inserido_no_input) * trinta / cem;

        parseFloat(valor_inserido_no_input) <= valor_para_desconto ? set_valor_total() : set_valor_total();
